class CreateJobPage{
    ...
    elements = {    
        ...
        socialCauseSearchTxt: () => cy.get('[style="transition: all 180ms ease 0ms; opacity: 1; visibility: visible;"] > ._content_t5srj_16 > ._container_16m87_1 > ._search_osujm_18 > ._container_6spvv_1 > ._input_6spvv_11'),
        searchedSocialcause: () => cy.contains('Poverty'),
        continueBtn: () => cy.get('[style="transition: all 180ms ease 0ms; opacity: 1; visibility: visible;"] > ._content_t5srj_16 > ._container_16m87_1 > ._bottom_16m87_19 > ._button_16z98_1'),
        skillLbl: () => cy.contains('Select up to 10 relevant skills'),
        skillSearchTxt: () => cy.get('[style="transition: all 180ms ease 0ms; opacity: 1; visibility: visible;"] > ._content_t5srj_16 > ._container_16m87_1 > ._search_osujm_18 > ._container_6spvv_1 > ._input_6spvv_11'),
        ...
        //continueBtnInScreenerStep: () => cy.get('.items-end > .bg-primary'),
        skipBtnInScreenerStep: () => cy.get('button[type="submit"]').contains('skip'),
        BackToJobBtn: () => cy.get('[style="transition: all 180ms ease 0ms; opacity: 1; visibility: visible;"] > ._content_t5srj_16 > ._btns_p8zh0_45 > ._button_16z98_1')       
    }  
    ...
    //this.elements.OrgAccount.first().click()   
    }
    clickOnCreatedLink() {
    ...
    selectJobCategory(JobCategory) {        
        ...
        this.elements.jobcategory().type(JobCategory)
