class CreatePostPage{
    ...
    setContext(PostText){
                this.elements.ContextTxt().click(),
                this.elements.ContextTxt().type(PostText)
    }

    setContextImg(PostTextImg){
                this.elements.ContextTxt().click(),
                this.elements.ContextTxt().type(PostTextImg),
                this.elements.UploadBtn().click(),
                this.elements.UploadBtn().UploadBtn.ImgUpload().selectFile('cypress/fixtures/NewPost.png', { force: true })
                //this.elements.UploadBtn.attachFile('cypress/fixtures/NewPost.png', { force: true })
    }
