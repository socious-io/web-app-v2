...
describe('search bar test automation for jobs', () => {
    ...
    it('user recieves an empty search result', () => {
        ...
        cy.contains('No organizations found').should('be.visible');
    ...
    it('user navigates to jobs page and opens the search organization modal and gets data inside the modal', () => {
        returnEmpty = false;
        cy.visit(`${APP_URL}/jobs`);
        cy.url().should('contain', '/jobs');
        cy.contains('Find work that matters to you and the world').should('be.visible');
    ...
    it('user navigates to jobs page and opens the search organization modal and clicks see all results', () => {
        returnEmpty = false;
        cy.visit(`${APP_URL}/jobs`);
        cy.url().should('contain', '/jobs');
        cy.contains('Find work that matters to you and the world').should('be.visible');
