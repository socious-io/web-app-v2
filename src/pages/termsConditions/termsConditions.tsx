  ...
  return (
    <div className={css.container}>
      ...
      <span>
        ...
        as &apos;the Company&apos;) provides services through this website at the domain “socious.io” and the services
        provided in this application (hereinafter referred to as &apos;the Services&apos;). (1) Terms of Use
        (hereinafter referred to as the &quot;Terms&quot;) set forth the terms and conditions of the Services and the
        relationship of rights and obligations between the Company and registered users. In order to use the Services,
        you must read and agree to these Terms of Use in their entirety.
      </span>
      ...
      <span>
        ...
        take precedence.
        <br />
        4. By clicking &quot;Register&quot; and registering for, accessing, and using our services as described below,
        you agree that you have entered into a legally binding contract with us. You may terminate this agreement at any
        time by cancelling your account and ceasing to access or use our services.
      </span>
      <strong>Article 2. Definitions</strong>
      <span>
        The following terms used in this Agreement shall have the meanings set forth below.
        <br />
        (1) Website: The website operated by the Company whose domain is &quot;socious.io/&quot; and whose name is
        &quot;Socious&quot; (if the domain or name of the Company&apos;s website is changed, the website after such
        change shall be included).
        <br />
        (2) Application: The application named &quot;Socious&quot; provided by the Company.
        <br />
        (3) Service: The service named &quot;Socious&quot; provided by the Company on the Site and the Application (if
        the name of the service is changed, the service after such change shall be included).
        <br />
      ...
      <span>
        1. A person who wishes to use the Services (hereinafter referred to as a &quot;Registration Applicant&quot;)
        must agree to comply with these Terms of Use and provide certain information as specified by the Company
        (hereinafter referred to as &quot;Registration Items&quot;). The person who wishes to use the Service
        (hereinafter referred to as the &quot;Registration Applicant&quot;) shall register with the Company for the use
        of the Service by agreeing to comply with the Terms and providing certain information (hereinafter referred to
        as the &quot;Registration Items&quot;) specified by the Company in a manner specified by the Company.
        (hereinafter referred to as &quot;Registration Applicant&quot;) may apply to the Company for registration to use
        the Service by agreeing to comply with these Terms and providing certain information (hereinafter referred to as
        &quot;Registration Items&quot;) to the Company in a manner prescribed by the Company.
        <br />
      ...
      <span>
        1. All intellectual property rights related to the Company&apos;s website and the Service belong to the Company
        or the party that has granted a license to the Company, and the granting of a license to use the Service under
      ...
      <span>
        ...
        the Company&apos;s website as compensation for the use of paid services among the Services, using the payment
      ...
      <span>
        ...
        notice or warning, delete or hide the posted data, temporarily suspend all or part of the registered user&apos;s
        use of the Service, restrict the registered user&apos;s use of the Service to establish connections or
        communicate with others, or cancel the registered user&apos;s registration.
        <br />
      ...
      <span>
        1. The Company may change the contents of the Service or terminate the provision of the Service at the
      ...
      <span>
        ...
        Agreement by posting a notice on the Company&apos;s website or by other appropriate means. However, in the case
        of a change in the content that requires the consent of the registered user under the law, the consent of the
      ...
      <span>
        ...
        users, such dispute shall be governed by the laws of the British Virgin Islands and the Magistrate&apos;s court
