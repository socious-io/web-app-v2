...
export const Mobile = (): JSX.Element => {
  ...
  const buttonHourlyJSX = () => (
    <div className={css.btnContainer}>
      <Button color="white" onClick={onEndJob}>
        End Job
      </Button>
    </div>
  );
    ...
    <>
      {showApprove ? (
        <div className={css.approveMain}>
          <div className={css.title}>Approve hours</div>
        ...
        <div className={css.container}>
          ...
          <div className={css.main}>
            {printWhen(
              hoursSubmissions(),
              applicantDetail.project?.payment_scheme === 'HOURLY' && applicantDetail.status === 'APPROVED'
            )}
