...
import { ImportModal } from '../../../../importLinkedIn/containers/ImportModal';
import { StepsContext } from '../Stepper';

export const ImportChoices = () => {
  const { updateSelectedStep } = useContext(StepsContext);

  const { steps, openImportModal, setOpenImportModal } = useImportChoices();
  return (
    <>
      ...
      <ImportModal open={openImportModal} handleClose={() => setOpenImportModal(false)} />
    </>
  );
};
