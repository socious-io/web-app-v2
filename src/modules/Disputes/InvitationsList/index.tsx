...
const InvitationsList: React.FC<InvitationsListProps> = ({ list }) => {
  ...
  return (
    <>
      ...
      {openModal.disputeInfo && (
        <InvitationModal
          open={openModal.name === 'invitation' && openModal.open}
          handleClose={handleCloseModal}
          disputeInfo={openModal.disputeInfo}
          onAccept={() => onAcceptOrDeclineInvitation('accept')}
          onDecline={() => onAcceptOrDeclineInvitation('decline')}
        />
      )}
      {openModal.disputeInfo && (
        <ExpiredModal
          open={openModal.name === 'expired' && openModal.open}
          handleClose={handleCloseModal}
          disputeInfo={openModal.disputeInfo}
        />
      )}
