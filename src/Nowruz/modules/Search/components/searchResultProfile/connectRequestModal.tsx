...
export const ConnectRequestModal: React.FC<ConnectRequestModalProps> = ({ open, handleClose, identity }) => {
  const { message, handleConnect, letterCount, error, handleChangeMessage } = useSearchResultProfile(identity);
