...
export const ReviewModal = ({ open, handleClose }) => {
    ...
    const { register, errors, onSubmit, handleSubmit, selectedValue, setSelectedValue, 
        cardOptionList,name,openSuccessModal,handleCloseSuccessModal  } = useReviewModal(handleClose);
    ...
    return (
        ...
        {!openSuccessModal &&
            ...
            >
                ...
                <div onClick={handleCloseSuccessModal}>dddd</div>
            </Modal>
        }
            <AlertModal
