...
export const IconDropDown: React.FC<IconDropDownProps> = (props) => {
  ...
  return (
    <div className="flex flex-col items-end relative">
      ...
      {open && (
        <div
          className={`w-[280px] bg-Base-White border border-solid border-Gray-light-mode-200 rounded-default shadow-Shadows/shadow-lg flex flex-col absolute top-[${size}] ${customStyle}`}
        >
          {accounts.map((a) => (
