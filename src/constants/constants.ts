...
export const NotificationType = {
  ...
  MEMBERED: 'MEMBERED',
  REFFERAL_JOINED: 'REFFERAL_JOINED',
  REFFERAL_VERIFIED: 'REFFERAL_VERIFIED',
  REFFERAL_HIRED: 'REFFERAL_HIRED',
  REFFERAL_COMPLETED_JOB: 'REFFERAL_COMPLETED_JOB',
  REFFERAL_CONFIRMED_JOB: 'REFFERAL_CONFIRMED_JOB',
