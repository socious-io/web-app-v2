...
export const NotificationTitle = {
  ...
  MEMBERED: 'Membered',
  REFERRAL_JOINED: 'Referred user joined',
  REFERRAL_VERIFIED: 'Referred user got verified',
  REFERRAL_HIRED: 'Referred user got hired',
  REFERRAL_COMPLETED_JOB: 'Referred user completed job',
  REFERRAL_CONFIRMED_JOB: 'Referred user confirmed job',
  EXPERIENCE_VERIFY_REQUEST: 'EXPERIENCE_VERIFY_REQUEST',
  EXPERIENCE_VERIFY_APPROVED: 'EXPERIENCE_VERIFY_APPROVED',
  EXPERIENCE_VERIFY_REJECTED: 'EXPERIENCE_VERIFY_REJECTED',
  EXPERIENCE_ISSUED: 'EXPERIENCE_ISSUED',
...
export const NotificationSettings = [
  {
    type: 'FOLLOWED' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'COMMENT_LIKE' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'POST_LIKE' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'CHAT' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'SHARE_POST' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'SHARE_PROJECT' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'COMMENT' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'APPLICATION' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'OFFER' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'REJECT' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'APPROVED' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'HIRED' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'PROJECT_COMPLETE' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'ASSIGNEE_CANCELED' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'ASSIGNER_CANCELED' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'ASSIGNER_CONFIRMED' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'CONNECT' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'ACCEPT_CONNECT' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
  {
    type: 'MEMBERED' as CoreNotificationType,
    in_app: true,
    email: true,
    push: true,
  },
