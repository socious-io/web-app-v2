export const SKILLS = {
  ...
  MATLAB: 'MATLAB',
  MAVEN: 'Maven',
  'MICROSOFT_T-SQL': 'Microsoft T-SQL',
  MONGODB: 'MongoDB',
  'NODE.JS': 'Node.js',
  NOSQL: 'NoSQL',
  ...
  ADOBE_PREMIER_PRO: 'Adobe Premier Pro',
  ADOBE_XD: 'Adobe XD',
  AFTER_EFFECTS: 'After Effects',
  AUTOCAD: 'AutoCAD',
  AUTODESK_FUSION_360: 'Autodesk Fusion 360',
  AUTODESK_INVENTOR: 'Autodesk Inventor',
  AVID_MEDIA_COMPOSER: 'Avid Media Composer',
  ...
  UI_DESIGN: 'User Interface (UI) Design',
  UX_DESIGN: 'User Experience (UX) Design',
  ...
  ESG: 'Environmental, Social, and Corporate Governance (ESG)',
  ESG_INVESTING: 'ESG Investing',
  RESPONSIBLE_INVESTING: 'Responsible Investing',
  DATA_ANALAYSIS: 'Data Analaysis',
