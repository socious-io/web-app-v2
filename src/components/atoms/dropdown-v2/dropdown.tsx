...
import { setInitialValue } from './dropdown.services';
...
export const Dropdown = (props: DropdownProps): JSX.Element => {
  ...
  useEffect(() => {
    ref.current!.value = setInitialValue(props.list, props.value);
  }, []);
  ...
  return (
    <div className={css.container}>
      ...
      <div className={css.inputContainer}>
        <input placeholder={props.placeholder} ref={ref} onChange={onSearch} className={css.input} />
